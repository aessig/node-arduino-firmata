(function() {
  ...
  exports = module.exports = ArduinoFirmata = (function(superClass) {
    ...
    ArduinoFirmata.FIRMATA_INPUT_PULLUP = 0x10;
    ...
    ArduinoFirmata.REPORT_FIRMWARE = 0x79;
    ...
    ArduinoFirmata.prototype.trans = function(pin) {
      if (typeof pin === 'string' && pin.charAt(0) === 'A') {
        return ArduinoFirmata.TRANSLATE[this.boardName][pin];
      } else {
        return pin;
      }
    };
      ...
      this.serialport.once('open', (function(_this) {
        return function() {
          ...
          cid = setInterval(function() {
            ...
            _this.write([ArduinoFirmata.START_SYSEX, ArduinoFirmata.REPORT_FIRMWARE, ArduinoFirmata.END_SYSEX]);
            return _this.write([ArduinoFirmata.REPORT_VERSION]);
          }, 500);
          _this.once('boardVersion', function(version) {
            return _this.once('reportFirmware', function(name) {
              clearInterval(cid);
    ...
    ArduinoFirmata.prototype.queryFirmware = function(callback) {
      return this.write([ArduinoFirmata.START_SYSEX, ArduinoFirmata.REPORT_FIRMWARE, ArduinoFirmata.END_SYSEX], callback);
    };
    ...
    ArduinoFirmata.prototype.process_input = function(input_data) {
      ...
      if (this.parsing_sysex) {
        if (input_data === ArduinoFirmata.END_SYSEX) {
          ...
          if (sysex_command === ArduinoFirmata.REPORT_FIRMWARE) {
            this.boardName = sysex_data[1];
            return this.emit('reportFirmware', this.boardName);
          } else {
